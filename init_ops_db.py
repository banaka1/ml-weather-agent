...
SAMPLE_METRICS = [
    (1, 45.2, 62.1, 38.5, "2026-09-10 10:00:00"),
    (1, 78.9, 71.3, 39.0, "2026-09-10 11:00:00"),
    (2, 32.1, 55.0, 42.1, "2026-09-10 11:00:00"),
    (3, 91.5, 88.7, 76.2, "2026-09-10 10:00:00"),
    (3, 95.3, 90.1, 77.0, "2026-09-10 11:00:00"),
    (4, 0.0, 0.0, 0.0, "2026-09-10 11:00:00"),
    (5, 28.4, 41.2, 55.8, "2026-09-10 11:00:00"),
]
...
def init_db():
    ...
    c.executemany(
        "INSERT INTO metrics (server_id, cpu, memory, disk, ts) VALUES (?, ?, ?, ?, ?)",
        SAMPLE_METRICS,
    )
    c.executemany(
